...
public final class LoginServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginRequest,
      com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginResponse> getLogInMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "logIn",
      requestType = com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginRequest.class,
      responseType = com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginRequest,
      com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginResponse> getLogInMethod() {
    io.grpc.MethodDescriptor<com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginRequest, com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginResponse> getLogInMethod;
      ...
      synchronized (LoginServiceGrpc.class) {
        if ((getLogInMethod = LoginServiceGrpc.getLogInMethod) == null) {
          LoginServiceGrpc.getLogInMethod = getLogInMethod = 
              io.grpc.MethodDescriptor.<com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginRequest, com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "LoginService", "logIn"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginResponse.getDefaultInstance()))
  ...
  public static abstract class LoginServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void logIn(com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginRequest request,
        io.grpc.stub.StreamObserver<com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginRequest,
                com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginResponse>(
  ...
  public static final class LoginServiceBlockingStub extends io.grpc.stub.AbstractStub<LoginServiceBlockingStub> {
    ...
    /**
     */
    public com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginResponse logIn(com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginRequest request) {
  ...
  public static final class LoginServiceFutureStub extends io.grpc.stub.AbstractStub<LoginServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginResponse> logIn(
        com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOG_IN:
          serviceImpl.logIn((com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginRequest) request,
              (io.grpc.stub.StreamObserver<com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.LoginResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class LoginServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.pranavkapoorr.helloworldgrpc.LoginServiceOuterClass.getDescriptor();
    }
